...
################# after merging indel hapmaps convert to panmap and then use maxRow to get largest variant per row to then parse SV lengths
hapmap2panmap LR.merged.DP.filtered.01maf.75miss.hapmap sample1 sample2 sample3 sample4 etc...
maxRow panmap
