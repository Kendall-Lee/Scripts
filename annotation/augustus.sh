...
#SBATCH --output=AUGUSTUS.out
#SBATCH --error=AUGUSTUS.err
#SBATCH --mail-user=kcl58759@uga.edu
#SBATCH --mail-type=END,FAIL

ml AUGUSTUS/3.4.0-foss-2019b
cd ./
export AUGUSTUS_CONFIG_PATH=/home/kcl58759/config_augustus

augustus --strand=forward --species=fusarium_graminearum --extrinsicCfgFile=   --gff3=on /scratch/kcl58759/Eco_pacbio_kendall/Hifiasm_stuff/212_assemblies/212.l0/212.l0.p.ctg.nocontam.fa
#augustus --strand=forward --species=FUNGUS --gff3=on --proteinprofile=proteins.fa /scratch/kcl58759/Eco_pacbio_kendall/Hifiasm_stuff/1033_assemblies/1033_l0/1033.l0.p.ctg.nocontam.fa
