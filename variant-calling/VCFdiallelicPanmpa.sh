#initial panmap number of line
3272324

#filter panmap for diallelic
panmapGetDiAlleles LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.panmap > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAllelic.panmap

#check how many lines are filtered out
wc -l LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAllelic.panmap
3146444
#get the alleles for each site in the panmap
panmapGetAlleles LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAllelic.panmap > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAlleles.txt

#check that the # of lines in the alleles matches the # of lines in the .panmap
#first line of this file is a header
cat LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAlleles.txt| wc -l
3146444
...
paste <(cat LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAllelic.panmap | cut -f1-3) LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAlleles.txt > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.alleles.part.txt &

#once confirmed, copy only the chr and pos columns to the alleles
paste <(cat LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAllelic.panmap | cut -f1-2) LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAlleles.txt  > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.alleles.part.txt &

#copy columns 4- to the allele calls
paste LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.alleles.part.txt <(cat LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.DiAllelic.panmap| cut -f4-) > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.alleles.full.txt
...
&& awk 'NR == 1 {$1 = "#CHROM"; $2 = "POS"} {print}' OFS="\t" LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.alleles.full.ref.alt.pansplit.convert.dummy.txt) > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.TEST.vcf

#rename chrs to match snpEff
sed -E 's/\bchr([0-9]{2})\b/TRv2Chr.\1/g' LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.TEST.vcf > LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.TEST.name.vcf

#check final number
cat LRLP_Smiss0.99_miss0.9_maf0.0_kmer0_depfull.TEST.name.vcf | grep -v "##" | wc -l
3146444
